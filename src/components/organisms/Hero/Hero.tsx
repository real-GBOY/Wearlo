...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center">
      <div className="absolute inset-0 bg-gradient-to-br from-white via-gray-100 to-black dark:from-black dark:via-gray-900 dark:to-white transition-colors duration-500" />
        ...
        <div className="max-w-4xl">
          ...
          >
            <Typography variant="body" className="max-w-2xl">
              ...
              Clean lines, premium materials, and thoughtful design.
            </Typography>
          </motion.div>
