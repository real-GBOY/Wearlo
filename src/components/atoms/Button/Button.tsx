...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-white text-black border border-black hover:bg-black hover:text-white focus:ring-gray-500 dark:bg-black dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black',
