        ...
        >
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <Button variant="outline" size="sm">XS</Button>
          ...
          <div className="pt-8 border-t border-gray-200 dark:border-gray-800">
            <div className="space-y-4">
              <div>
                <Typography variant="h4" className="mb-2">Shipping & Returns</Typography>
                <Typography variant="body" className="text-sm">
                  Free shipping on orders over $100. 30-day returns accepted.
                </Typography>
              </div>
              <div>
                <Typography variant="h4" className="mb-2">Care Instructions</Typography>
                <Typography variant="body" className="text-sm">
